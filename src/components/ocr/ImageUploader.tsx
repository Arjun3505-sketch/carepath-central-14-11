  ...
  const handleProcessImage = async () => {
    ...
    try {
      toast({
        ...
        description: "Gemini AI is extracting and understanding your medical document...",
      });
      ...
      if (text && text.trim().length > 0) {
        ...
        if (jsonMatch) {
          ...
          toast({
            ...
            description: "Form fields have been auto-filled with AI-extracted data. Please review.",
          });
        } else {
      ...
      toast({
        ...
        description: err.message || "Failed to process the document. Please try again.",
        variant: "destructive",
      });
    } finally {
      setProcessing(false);
